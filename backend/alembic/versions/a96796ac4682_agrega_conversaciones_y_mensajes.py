...
Revision ID: a96796ac4682
Revises: 54318b7dadd5
Create Date: 2026-09-14 00:00:00.000000

Ticket "[Frontend] Pantalla Mensajes Docentes del Aprendiz". El backend
(modelo/repositorio/servicio/endpoints/tests) ya existía completo en la
rama `main` (SCRUM-119, épica SCRUM-97) pero no en `develop`/`nicol` —
se porta tal cual desde ahí (mismo módulo `app/models/mensajeria.py` y
compañía) en vez de reimplementarlo, solo se re-encadena esta migración
sobre la cabeza actual de `nicol`. Mockup
...
revision: str = 'a96796ac4682'
down_revision: Union[str, Sequence[str], None] = '54318b7dadd5'
