...
const badgeEstado: Record<Estado, string> = {
  Confirmado: 'bg-primary-container text-on-primary-container dark:bg-emerald-950/50 dark:text-emerald-300',
  Cruce: 'bg-tertiary-container text-on-tertiary-container dark:bg-orange-950/50 dark:text-orange-300',
  'Por confirmar': 'bg-surface-container text-on-surface-variant dark:bg-slate-700 dark:text-slate-300',
}
  ...
  return (
    <AppShell activo="Inicio">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="mb-1 text-2xl font-bold text-on-surface dark:text-slate-100">Panel de programación</h1>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-5 dark:border-slate-700 dark:bg-slate-800">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="h-6 w-6 rounded-md bg-primary-container dark:bg-emerald-950/50" />
          </div>
          <p className="text-3xl font-bold text-on-surface dark:text-slate-100">128</p>
          <p className="mt-1 text-sm font-medium text-primary dark:text-emerald-300">
        ...
        <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-5 dark:border-slate-700 dark:bg-slate-800">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="h-6 w-6 rounded-md bg-tertiary-container dark:bg-orange-950/50" />
          </div>
          <div className="flex items-center gap-2">
            <p className="text-3xl font-bold text-on-surface dark:text-slate-100">7</p>
          ...
          <p className="mt-1 text-sm text-on-surface-variant dark:text-slate-400">4 por instructor · 3 por ambiente</p>
        </div>
        ...
        <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-5 dark:border-slate-700 dark:bg-slate-800">
          <div className="mb-3 flex items-center justify-between">
            ...
            <span className="h-6 w-6 rounded-md bg-surface-container dark:bg-slate-700" />
          </div>
          <p className="text-3xl font-bold text-on-surface dark:text-slate-100">
            19 <span className="text-lg font-medium text-on-surface-variant dark:text-slate-400">/ 34</span>
          </p>
          <div className="mt-3 h-1.5 w-full rounded-full bg-surface-container dark:bg-slate-700">
            <div className="h-1.5 rounded-full bg-primary" style={{ width: '56%' }} />
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-outline-variant bg-surface-container-lowest p-5 dark:border-slate-700 dark:bg-slate-800">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-lg font-semibold text-on-surface dark:text-slate-100">Horario de hoy</p>
            <p className="text-sm text-on-surface-variant dark:text-slate-400">
              ...
              {filas.map((fila) => (
                <tr
                  ...
                  className={`border-b border-outline-variant last:border-0 dark:border-slate-700 ${
                    fila.estado === 'Cruce' ? 'bg-tertiary-container/40 dark:bg-orange-950/30' : ''
                  }`}
                >
                  <td className="py-3 pr-4 font-semibold text-on-surface dark:text-slate-100">{fila.hora}</td>
                  <td className="py-3 pr-4 text-on-surface-variant dark:text-slate-300">{fila.ficha}</td>
                  <td className="py-3 pr-4 text-on-surface-variant dark:text-slate-300">{fila.programa}</td>
                  <td className="py-3 pr-4 text-on-surface-variant dark:text-slate-300">{fila.instructor}</td>
                  <td className="py-3 pr-4 text-on-surface-variant dark:text-slate-300">{fila.ambiente}</td>
                  <td className="py-3">
                    <span
